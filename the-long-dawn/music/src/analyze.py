...
SYNC = [
    ...
    (1360, "beacon ROARS / horn (timp hit)", "timp", 0.05, "hit"),
    (1360, "beacon ROARS (mix)", "mix", 0.05, "hit"),
    ...
    (1760, "globe: choir enters (timp hit)", "timp", 0.05, "hit"),
    (1760, "globe: choir enters (mix)", "mix", 0.05, "hit"),
